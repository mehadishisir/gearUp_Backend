...
-- CreateTable
CREATE TABLE "rental_orders_items" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "rental_orders_items_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "rental_orders_items" ADD CONSTRAINT "rental_orders_items_rentalOrderId_fkey" FOREIGN KEY ("rentalOrderId") REFERENCES "rental_orders"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "rental_orders_items" ADD CONSTRAINT "rental_orders_items_gearItemId_fkey" FOREIGN KEY ("gearItemId") REFERENCES "gear_items"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
